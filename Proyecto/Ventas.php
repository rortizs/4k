    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="sistema/index.php" class="nav-link">Home</a>
        </li>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <div align="center">Descripción de Producto</div>
                      </th>
                      <th>
                  ...
                  <tbody>
                    <tr>
                      <td colspan=7>
                        <center><label>
                            <p class="bg-primary">Sin Produtos Agregados</p>
                          </label></center>
                      </td>
                    </tr>
                  </tbody>
                ...
                <table width="302" id="carritototal">
                  <tr>
                    ...
                    <td width="123">
                      <div align="right" class="Estilo9"><label id="lblsubtotal" name="lblsubtotal">0.00</label><input type="hidden" name="txtsubtotal" id="txtsubtotal" value="0.00" /></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="123">
                      <div align="right" class="Estilo9"><label id="lblsubtotal2" name="lblsubtotal2">0.00</label><input type="hidden" name="txtsubtotal2" id="txtsubtotal2" value="0.00" /></div>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="Estilo9"><label>IVA 12.00%<input name="iva" id="iva" type="hidden" value="12.00" /></label></span></td>
                    <td>
                      <div align="right" class="Estilo9"><label id="lbliva" name="lbliva">0.00</label><input type="hidden" name="txtIva" id="txtIva" value="0.00" /></div>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="Estilo9"><label>Descuento:</label></span></td>
                    <td>
                      <div align="right" class="Estilo9"><label id="lbldescuento" name="lbldescuento">0.00</label><input type="hidden" name="txtDescuento" id="txtDescuento" value="0.00" /></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div align="right" class="Estilo9"><label id="lbltotal" name="lbltotal">0.00</label><input type="hidden" name="txtTotal" id="txtTotal" value="0.00" />
                        <input type="hidden" name="txtTotalCompra" id="txtTotalCompra" value="0.00" /></div>
                    </td>
                  </tr>
