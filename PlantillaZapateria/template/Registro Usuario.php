...
<body>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <form method="post">
        ...
        <input type="dpi" name="Dpi" placeholder="DPI">
    	<input type="direccion" name="Direccion" placeholder="Direccion">
        <input type="telefono" name="Telefono" placeholder="Numero de Telefono">
        <input type="email" name="Email" placeholder="Email">
        <input type="cargo" name="Cargo" placeholder="Cargo">
        <input type="user" name="Username" placeholder="Nombre del Usuario">
