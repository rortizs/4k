...
<head>
  ...
  <title>Listado de Usuarios | Zapatería Novedades</title>
...
" }>
  <center>
    ...
    <div id="header">
      <div id="content">
        <label>Usuarios Registrados |<a target="_blank"></a> Zapatería Novedades</a></label>
    ...
    <div id="body">
      <th colspan="5"><a href="add_usuario.php" button class="btn btn-primary btn-md">Agrear Usuario</a></th>
        ...
        <table align="center">
          ...
          ?>
            <tr>
              ...
              <?php } else { ?>
                <td align="center"><a button class="btn btn-success btn-xs" href="javascript:changestatus_id('<?php echo $row[0]; ?>',1)  ">Dar de Alta</a></td>
              <?php } ?>
