	...
	<body>
		...
		<div class="col-sm-3">
			...
			<span class="btn btn-warning btn-xs" data-toggle="modal" data-target="#actualizaCategoria">
				<span class="glyphicon glyphicon-pencil">Agregar Categoría</span>
			</span>
		</div>
		</div>
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Agrega Categoría</h4>
					</div>
					...
					<div class="modal-footer">
						<button type="button" id="btnAgregaCategoria" class="btn btn-warning" data-dismiss="modal">Guardar</button>
